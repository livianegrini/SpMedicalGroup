...
export default function CadastrarConsulta() {
  ...
  //   axios('http://192.168.0.15:5000/api/Paciente', {
  //     headers: {
  ...
  //   //o método por padrão será o GET.
  //   axios('http://192.168.0.15:5000/api/Medico', {
  //     headers: {
  //       //comunicação JWT, o padrao da api Bearer + token.
  //       Authorization: 'Bearer ' + localStorage.getItem('Usuario-Login'),
  //     },
  ...
  //   //o método por padrão será o GET.
  //   axios('http://192.168.0.15:5000/api/Clinica', {
  //     headers: {
  //       //comunicação JWT, o padrao da api Bearer + token.
  //       Authorization: 'Bearer ' + localStorage.getItem('Usuario-Login'),
  //     },
  ...
  //   //o método por padrão será o GET.
  //   axios('http://192.168.0.15:5000/api/Situacao', {
  //     headers: {
  //       //comunicação JWT, o padrao da api Bearer + token.
  //       Authorization: 'Bearer ' + localStorage.getItem('Usuario-Login'),
  //     },
  ...
  //   axios.post('http://192.168.0.15:5000/api/Consulta', {
